...
public class AppDbContext : DbContext
{
    ...
    private static void ConfigureComponent(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Component>(entity =>
        {
            ...
            entity.Property(component => component.ManufacturerId)
                .IsRequired();

            entity.Property(component => component.TypeId)
                .IsRequired();

            entity.HasOne(component => component.Manufacturer)
                .WithMany(manufacturer => manufacturer.Components)
                .HasForeignKey(component => component.ManufacturerId)
                .OnDelete(DeleteBehavior.Restrict);

            entity.HasOne(component => component.Type)
                .WithMany(type => type.Components)
                .HasForeignKey(component => component.TypeId)
                .OnDelete(DeleteBehavior.Restrict);
        });
    }
